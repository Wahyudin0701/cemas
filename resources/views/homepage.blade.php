...
<nav id="navbar"
    class="navbar-blur fixed top-0 w-full z-20 shadow-sm bg-white/70 backdrop-blur">
...
<section class="pt-32 pb-24 min-h-screen flex items-center fade-in bg-gradient-to-br from-gray-50 via-blue-50 to-blue-300">
    <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="hidden md:block">
            <img
                src="{{ asset('Images/lorong_asvil.jpg') }}"
                class="rounded-xl shadow-lg hover:scale-[1.02] duration-500"
                alt="Lorong Aston Villa">
        </div>
    </div>
</section>
...
<section id="daftar-toko" class="py-28 bg-gradient-to-tr from-gray-50 via-blue-50 to-blue-300">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div class="card bg-white p-6 rounded-xl shadow border border-gray-100 
...
<section id="tentang" class="py-24 bg-gradient-to-b from-white to-blue-50">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 fade-in">
            ...
            <!-- CARD 1 -->
            <div class="bg-white rounded-2xl p-8 shadow-md border border-gray-100 hover:shadow-lg 
            ...
            <div class="bg-white rounded-2xl p-8 shadow-md border border-gray-100 hover:shadow-lg 
                ...
                <p class="text-gray-600 text-sm mt-2">
                    CeMas dibangun khusus untuk warga, sehingga transaksi lebih dekat, mudah, dan mendukung ekonomi lokal.
                </p>
            </div>
