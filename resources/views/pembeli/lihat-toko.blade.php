        ...
        <nav class="bg-white shadow-sm sticky top-0 z-10">
            <div class="max-w-7xl mx-auto px-6 h-16 flex items-center relative gap-4">
                <a href="{{ route('pembeli.dashboard') }}"
                    class="flex items-center text-gray-800 hover:text-gray-900 text-sm font-medium">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        @forelse ($toko->produks as $produk)
                            <div
                                ...
                                @endif
                                <div class="p-4">
                                    <h3 class="font-semibold text-gray-900 text-sm h-10 line-clamp-2">
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">Stok: <span
                                            class="font-semibold">{{ $produk->stok }}</span></p>
            ...
            items.forEach(item => {
                ...
                <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex gap-3 relative group">
                    <div class="bg-gray-100 w-16 h-16 rounded-lg flex-shrink-0 overflow-hidden">
                         <img src="${item.produk.foto_produk_url ? item.produk.foto_produk_url : 'https://placehold.co/100x100?text=IMG'}" class="w-full h-full object-cover">
                    </div>
                    <div class="flex-1">
