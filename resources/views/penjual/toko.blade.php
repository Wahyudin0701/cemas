        ...
        <div class="grid md:grid-cols-2 gap-10">
            ...
            <div class="space-y-6">
                ...
                <div class="relative">
                    ...
                    <label class="absolute left-4 top-3 bg-white px-1 text-gray-500 transition-all duration-150
                ...
                <div class="relative">
                    ...
                    <span class="absolute right-4 top-4 text-gray-400 text-xs">▼</span>
                </div>
